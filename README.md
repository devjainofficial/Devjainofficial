...
**AutoClip AI** - Automated short-form video pipeline.
[autoclipai.vercel.app](https://autoclipai.vercel.app)

## Stack

**Backend** C#, ASP.NET Core, Blazor, Entity Framework, ABP.IO, Python, FastAPI
**Data** MSSQL, PostgreSQL, Supabase, Redis, RabbitMQ
**Cloud** AWS (EC2, RDS, S3, ALB, CloudFront), Oracle Cloud, Azure Entra ID, CI/CD
**AI** LLM integration, agentic systems, MCP, OpenAI Agents SDK, LangGraph, CrewAI

## Contact

[LinkedIn](https://www.linkedin.com/in/devjainofficial/) · devjainofficials@gmail.com
